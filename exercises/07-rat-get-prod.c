...
int main() {
    ...
    printf("Enter the numerator and denominator of the first rational number (separated by a space): ");
    scanf("%d %d", &a.numerator, &a.denominator);

    // Input for the second rational number
    printf("Enter the numerator and denominator of the second rational number (separated by a space): ");
